      ...
      <div className="px-6 py-16 sm:px-6 sm:py-24 lg:px-8 rounded-md">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              href={primary ?? '/'}
              className="rounded-md bg-sky-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-sky-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
            >
              {primaryText}
            </Link>
            {secondary && (
